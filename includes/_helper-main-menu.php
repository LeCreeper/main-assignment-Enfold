		...
		?>
				 ...
				 <div class='container'>
						...
						*/
						    ...
						    // Inject responsive shopping cart
							    echo "<div class='visible-mobile shopping-cart-wrapper'>";
							    echo yanco_avia_woocommerce_cart_dropdown();
							    echo "<span id='shiftnav-toggle-main-button' class='shiftnav-toggle shiftnav-toggle-shiftnav-main shiftnav-toggle-burger' data-shiftnav-target='shiftnav-main'><i class='fa fa-bars'></i><span class='menu-text'>MENU</span></span>";
							    echo "</div>";
